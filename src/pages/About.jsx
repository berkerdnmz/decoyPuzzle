  ...
  return (
    <div className="about-page">
      ...
      <div className="about-sections">
        ...
        <div className="about-section">
          <h2>Tech stack</h2>
          <p>React + Vite · Supabase (PostgreSQL + Auth) · chess.js · react-chessboard · GitHub Pages</p>
        </div>

        <div className="about-section">
          <h2>Puzzle data</h2>
          <p>
            Puzzles sourced from the <a href="https://database.lichess.org" target="_blank" rel="noopener noreferrer">Lichess open database</a> under the CC0 license. Lichess is a free, open source chess server.
          </p>
        </div>
